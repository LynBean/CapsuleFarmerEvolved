# Credit for a large portion of this code goes to https://github.com/thomaswieland,
# I really didn't see a reason to redo what was already well made.
# However all the code within the dosync function is all original (along with some other minor changes)

from .Exceptions import FailFind2FAException
from datetime import datetime
from threading import *
import email # built using https://github.com/jazzband/imaplib2/
import imaplib2
import re
import time
